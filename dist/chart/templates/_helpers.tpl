...
*/}}
{{- define "uptime-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "uptime-operator.resourceName" -}}
{{- $fullname := include "uptime-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
{{- else }}
{{- include "uptime-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
